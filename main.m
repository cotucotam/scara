...
% Last Modified by GUIDE v2.5 16-Apr-2022 13:14:35
...
%     yaw = str2num(get(handles.DisplayCurrentYaw,'String'));\
    x = get(handles.SliderX,'value');
    set(handles.DisplayX,'string',num2str(x));
...
try
    ...
    set(handles.DisplayY,'string',num2str(y));
...
try
    ...
    set(handles.DisplayZ,'string',num2str(z));
    y = str2num(get(handles.DisplayY,'String'));
    x = str2num(get(handles.DisplayX,'String'));
    yaw = str2num(get(handles.DisplayYaw,'String'));
    global Scara;
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
try
    yaw = get(handles.SliderYaw,'value');
    set(handles.DisplayYaw,'string',num2str(yaw));
    y = str2num(get(handles.DisplayY,'String'));
    x = str2num(get(handles.DisplayX,'String'));
    z = str2num(get(handles.DisplayZ,'String'));
    global Scara;
    I = Scara.invest_kinnematic(Scara,x,y,z,yaw);
    if I(5) == 1
        set(handles.DisplayTheta1,'string',num2str(I(1))); 
        set(handles.DisplayTheta2,'string',num2str(I(2)));
        set(handles.DisplayTheta4,'string',num2str(I(3)));
